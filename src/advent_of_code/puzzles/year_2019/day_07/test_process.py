from advent_of_code.puzzles.year_2019.day_07 import process


def test_example_1():
    text = "3,15,3,16,1002,16,10,16,1,16,15,15,4,15,99,0,0"
    output = process.highest_signal(text)
    assert output == 43210
...
def test_example_4():
    ...
    output = process.highest_signal(text, range(5, 10), feedback_loop=True)
