...
class BoilingBoulders:
    ...
    def calculate_external_surface_area(self):
        ...
        start_cube = sorted(self.droplet_cubes, key=lambda coord: coord.x)[
            0
        ]  # start at an example of lowest x
        ...
        while bfs_q:
            ...
            for empty_point in unseen_empty_points:
                neighbour_of_neighbour_points = {
                    empty_point + offset for offset in COORD_OFFSETS
                }
                empty_neighbour_of_neighbour_points = (
                    neighbour_of_neighbour_points - self.droplet_cubes
                )
