...
from advent_of_code.year_2022.day_20 import process_other
...
4"""
    ...
    assert (
        str(gps.grove_linked_list)
        == "deque([811589153, 1623178306, -2434767459, 2434767459, -1623178306, 0, 3246356612])"
    )
    ...
    assert (
        str(gps.grove_linked_list)
        == "deque([0, -2434767459, 1623178306, 3246356612, -1623178306, 2434767459, 811589153])"
    )
