...
class NotEnoughMaterials:
    ...
    def simulate(self, blueprint, mineral_states):
        ...
        for mineral_state in mineral_states:
            ...
            if (
                mineral_state.ore >= blueprint.ore.ore
            ...
            if (
                mineral_state.ore >= blueprint.clay.ore
            ):  # base calculation on original ore levels:
                next_mineral_state = MineralState(
                    ore_robots=mineral_state.ore_robots,
            ...
            if (
                mineral_state.ore >= blueprint.obsidian.ore
                and mineral_state.clay >= blueprint.obsidian.clay
            ):  # base calculation on original ore levels:
                next_mineral_state = MineralState(
                    ore_robots=mineral_state.ore_robots,
                    clay_robots=mineral_state.clay_robots,
            ...
            if (
                mineral_state.ore >= blueprint.geode.ore
                and mineral_state.obsidian >= blueprint.geode.obsidian
            ):  # base calculation on original ore levels:
                next_mineral_state = MineralState(
                    ore_robots=mineral_state.ore_robots,
                    clay_robots=mineral_state.clay_robots,
