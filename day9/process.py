...
class EncodingError:
    ...
    def first_number_not_total_of_previous_two(self, window_size):
        for window in more_itertools.windowed(self.cypher, window_size + 1):
            ...
            total, = total
            result = self._first_number_not_total_of_previous_two(previous_numbers, total)
            if not result:
                return total
...
def main():
    ...
    first_number_not_total_of_previous_two = encoding_error.first_number_not_total_of_previous_two(window_size=25)
    print(f'First number not the sum of two of the 25 numbers before it: {first_number_not_total_of_previous_two}')
    print(
