from year_2023.day_16 import process
...
..//.|...."""
    ...
    assert energised_spaces == {
        ...
        process.Coords(6, 2): {process.Direction.LEFTWARDS, process.Direction.RIGHTWARDS},
        ...
        process.Coords(5, 6): {process.Direction.DOWNWARDS, process.Direction.RIGHTWARDS},
        ...
        process.Coords(1, 7): {process.Direction.LEFTWARDS, process.Direction.RIGHTWARDS},
        ...
        process.Coords(5, 8): {process.Direction.LEFTWARDS, process.Direction.DOWNWARDS},
        process.Coords(6, 8): {process.Direction.LEFTWARDS, process.Direction.RIGHTWARDS},
...
..//.|...."""
    ...
    assert best_energised_spaces == {
        process.Coords(1, 0): {process.Direction.UPWARDS, process.Direction.DOWNWARDS},
        process.Coords(2, 0): {process.Direction.LEFTWARDS},
        process.Coords(3, 0): {process.Direction.LEFTWARDS, process.Direction.DOWNWARDS},
        process.Coords(4, 0): {process.Direction.LEFTWARDS},
        process.Coords(5, 0): {process.Direction.LEFTWARDS},
        process.Coords(1, 1): {process.Direction.DOWNWARDS},
        ...
        process.Coords(4, 6): {process.Direction.RIGHTWARDS},
        process.Coords(5, 6): {process.Direction.RIGHTWARDS, process.Direction.DOWNWARDS},
        process.Coords(6, 6): {process.Direction.UPWARDS, process.Direction.DOWNWARDS},
        process.Coords(7, 6): {process.Direction.LEFTWARDS},
        process.Coords(0, 7): {process.Direction.LEFTWARDS},
        process.Coords(1, 7): {process.Direction.LEFTWARDS, process.Direction.RIGHTWARDS},
        process.Coords(2, 7): {process.Direction.LEFTWARDS, process.Direction.RIGHTWARDS},
        process.Coords(3, 7): {process.Direction.LEFTWARDS, process.Direction.RIGHTWARDS},
        process.Coords(4, 7): {process.Direction.UPWARDS},
        process.Coords(5, 7): {process.Direction.DOWNWARDS},
        process.Coords(6, 7): {process.Direction.DOWNWARDS},
        process.Coords(7, 7): {process.Direction.UPWARDS},
